...
{
    public class StartWordCellsFinder
    {
        private readonly PlayingFieldCell[,] _grid;

        public StartWordCellsFinder(PlayingFieldCell[,] grid)
        {
            _grid = grid;
        }

        public Dictionary<Vector2, CheckingFieldDirection> FindStartCellsIndexes() 
        {
